# BYOD下におけるmagiot用開発環境の構築
## リポジトリの内容
- このリポジトリの内容はmagiotプロジェクトにおいて，firebaseアプリケーション(html/python)を開発するために必要な環境をまとめたものである．
- 実行環境はPython3.8.2, node-v12.16.3-win-x64, visual studio code-1.44.0-30
